...
<body>
	...
	<h2 id="Shoph2">Update the Data</h2>
	
	<form action="" method="POST" enctype="multipart/form-data" class="border border-secondary sedit">	
		<input type="hidden" name="newarrival" value="<?php echo $data['SN'];?>"/>
		...
		<img src="<?php echo $img_path.$data['P_Image'];?>"  class="rounded mx-auto d-block" alt=""/>
		</br>
		<div>
